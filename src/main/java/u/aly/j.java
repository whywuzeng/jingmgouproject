...
public class j extends a
{
  ...
  private String g()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 58	u/aly/j:h	()Ljava/io/File;
    //   4: astore_1
    //   5: aload_1
    //   6: ifnull +10 -> 16
    //   9: aload_1
    ...
    //   27: aload_0
    //   28: aload_1
    //   29: invokestatic 73	u/aly/cd:a	(Ljava/io/InputStream;)Ljava/lang/String;
    //   32: invokespecial 75	u/aly/j:b	(Ljava/lang/String;)Ljava/lang/String;
    //   35: astore_2
    //   36: aload_1
    //   37: invokestatic 78	u/aly/cd:c	(Ljava/io/InputStream;)V
    //   40: aload_2
    //   41: areturn
    //   42: astore_1
    //   43: aload_1
    ...
    //   49: astore_2
    //   50: aload_1
    //   51: invokestatic 78	u/aly/cd:c	(Ljava/io/InputStream;)V
    //   54: aload_2
    //   55: athrow
    //
    // Exception table:
  ...
  private File h()
  {
    if (!bq.a(this.d, "android.permission.WRITE_EXTERNAL_STORAGE"));
