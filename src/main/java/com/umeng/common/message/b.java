...
public class b
{
    ...
    throws Exception
  {
    ...
    label76: for (Object localObject1 = paramJSONObject.getString("country"); ; localObject1 = null)
    {
    ...
    throws Exception
  {
    ...
    for (this.c = com.umeng.message.proguard.b.a(new String[] { this.c, "utf-8", this.a.substring(0, 16) }); ; this.c = com.umeng.message.proguard.b.a(new String[] { this.c, "utf-8" }))
    {
  ...
  public void a(Context paramContext)
  {
    ...
    this.j = UmengMessageDeviceConfig.getResolution(paramContext);
  ...
  public void a(Context paramContext, String[] paramArrayOfString)
  {
    ...
    this.c = UmengMessageDeviceConfig.getDeviceId(paramContext);
    this.d = UmengMessageDeviceConfig.getDeviceIdMD5(paramContext);
    this.e = UmengMessageDeviceConfig.getMac(paramContext);
  }
  ...
  {
    this.n = UmengMessageDeviceConfig.getAppVersionName(paramContext);
    this.o = UmengMessageDeviceConfig.getAppVersionCode(paramContext);
    this.p = UmengMessageDeviceConfig.getPackageName(paramContext);
  }
  ...
  {
    this.s = UmengMessageDeviceConfig.getTimeZone(paramContext);
    paramContext = UmengMessageDeviceConfig.getLocaleInfo(paramContext);
  ...
  {
    String[] arrayOfString = UmengMessageDeviceConfig.getNetworkAccessMode(paramContext);
    this.v = arrayOfString[0];
    this.w = arrayOfString[1];
    this.x = UmengMessageDeviceConfig.getOperator(paramContext);
  }
}
