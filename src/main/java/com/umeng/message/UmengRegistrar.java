...
public class UmengRegistrar extends BaseRegistrar
{
  ...
  static void a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (Build.VERSION.SDK_INT > 11)
      i = 4;
    Object localObject = paramContext.getSharedPreferences("umeng_message_state", i);
  ...
  public static IMtopService getIMtopService(Context paramContext)
  {
    return BaseRegistrar.getMtopService(paramContext);
  }
  ...
  public static void register(Context paramContext, String paramString1, String paramString2)
  {
    ...
    aU.a(paramContext, new Class[] { SystemReceiver.class, RegistrationReceiver.class, MessageReceiver.class });
    a.d(paramContext, UmengUT.class.getName());
    a.e(paramContext, "umeng");
    baseRegister(paramContext, "umeng:" + paramString1, paramString2, "android@umeng");
  }
