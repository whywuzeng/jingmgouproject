...
public final class AbGraphicUtil
{
  public static int drawText(Canvas paramCanvas, String paramString, int paramInt1, TextPaint paramTextPaint, int paramInt2, int paramInt3)
  {
    ...
    int i = (int)getDesiredHeight(paramTextPaint);
    paramInt1 = 0;
    while (true)
    {
  ...
  public static float getDesiredHeight(TextPaint paramTextPaint)
  {
 ...
 * Qualified Name:     com.ismartgo.app.andbase.util.AbGraphicUtil
