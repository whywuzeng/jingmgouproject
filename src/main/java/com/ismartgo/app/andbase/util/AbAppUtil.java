...
public class AbAppUtil
{
  ...
  public static boolean importDatabase(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   45: aload_0
    //   46: invokevirtual 75	android/content/Context:getPackageName	()Ljava/lang/String;
    ...
    //   64: invokespecial 64	java/io/File:<init>	(Ljava/lang/String;)V
    //   67: astore 14
    //   69: aload 13
    //   71: astore_1
    //   72: aload 10
    ...
    //   82: astore 7
    //   84: aload 14
    //   86: invokevirtual 107	java/io/File:exists	()Z
    //   89: ifne +133 -> 222
    //   92: aload 10
    //   94: astore 6
    //   96: aload 11
    ...
    //   102: astore 7
    //   104: aload 14
    //   106: invokevirtual 111	java/io/File:getParentFile	()Ljava/io/File;
    ...
    //   125: astore 7
    //   127: aload 14
    //   129: invokevirtual 111	java/io/File:getParentFile	()Ljava/io/File;
    //   132: invokevirtual 114	java/io/File:mkdirs	()Z
    //   135: pop
    //   136: aload 10
    //   138: astore 6
    //   140: aload 11
    ...
    //   146: astore 7
    //   148: aload 14
    //   150: invokevirtual 117	java/io/File:createNewFile	()Z
    //   153: pop
    //   154: aload 10
    //   156: astore 6
    //   158: aload 11
    ...
    //   164: astore 7
    //   166: aload_0
    //   167: invokevirtual 53	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   170: iload_2
    //   171: invokevirtual 121	android/content/res/Resources:openRawResource	(I)Ljava/io/InputStream;
    //   174: astore_0
    //   175: aload 10
    //   177: astore 6
    //   179: aload_0
    ...
    //   182: aload_0
    //   183: astore 7
    //   185: new 123	java/io/FileOutputStream
    //   188: dup
    //   189: aload 14
    //   191: invokespecial 126	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   194: astore_1
    //   195: sipush 1024
    //   198: newarray byte
    //   200: astore 5
    //   202: aload_0
    //   203: aload 5
    //   205: invokevirtual 132	java/io/InputStream:read	([B)I
    //   208: istore_2
    //   209: iload_2
    //   210: ifgt +41 -> 251
    //   213: aload_1
    //   214: invokevirtual 135	java/io/FileOutputStream:flush	()V
    //   217: aload_1
    //   218: astore 8
    //   220: aload_0
    //   221: astore_1
    ...
    //   227: ifnull +8 -> 235
    //   230: aload 8
    //   232: invokevirtual 138	java/io/FileOutputStream:close	()V
    //   235: iload 4
    //   237: istore_3
    //   238: aload_1
    //   239: ifnull +10 -> 249
    //   242: aload_1
    //   243: invokevirtual 139	java/io/InputStream:close	()V
    //   246: iload 4
    //   248: istore_3
    //   249: iload_3
    //   250: ireturn
    ...
    //   254: iconst_0
    //   255: iload_2
    //   256: invokevirtual 143	java/io/FileOutputStream:write	([BII)V
    //   259: goto -57 -> 202
    //   262: astore 8
    //   264: aload_1
    //   265: astore 6
    ...
    //   268: astore 5
    //   270: aload 8
    //   272: invokevirtual 87	java/lang/Exception:printStackTrace	()V
    //   275: aload_1
    //   276: ifnull +7 -> 283
    //   279: aload_1
    //   280: invokevirtual 138	java/io/FileOutputStream:close	()V
    //   283: aload_0
    //   284: ifnull -35 -> 249
    //   287: aload_0
    //   288: invokevirtual 139	java/io/InputStream:close	()V
    //   291: iconst_0
    //   292: ireturn
    //   293: astore_0
    //   294: iconst_0
    ...
    //   299: ifnull +8 -> 307
    //   302: aload 6
    //   304: invokevirtual 138	java/io/FileOutputStream:close	()V
    //   307: aload 5
    //   309: ifnull +8 -> 317
    //   312: aload 5
    //   314: invokevirtual 139	java/io/InputStream:close	()V
    //   317: aload_0
    //   318: athrow
    //   319: astore_1
    //   320: goto -37 -> 283
 ...
 * Qualified Name:     com.ismartgo.app.andbase.util.AbAppUtil
