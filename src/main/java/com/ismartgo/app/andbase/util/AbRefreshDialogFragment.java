...
public class AbRefreshDialogFragment extends AbDialogFragment
{
  ...
  public static AbRefreshDialogFragment newInstance(int paramInt1, int paramInt2)
  {
    AbRefreshDialogFragment localAbRefreshDialogFragment = new AbRefreshDialogFragment();
    Bundle localBundle = new Bundle();
    localBundle.putInt("style", paramInt1);
    localBundle.putInt("theme", paramInt2);
    localAbRefreshDialogFragment.setArguments(localBundle);
    return localAbRefreshDialogFragment;
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.mImageView.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        AbRefreshDialogFragment.this.load(paramAnonymousView);
      }
    });
 ...
 * Qualified Name:     com.ismartgo.app.andbase.util.AbRefreshDialogFragment
