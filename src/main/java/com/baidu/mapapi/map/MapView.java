...
public final class MapView extends ViewGroup
{
  ...
  private void b(Context paramContext, BaiduMapOptions paramBaiduMapOptions)
  {
    ...
    for (this.b = new com.baidu.platform.comapi.map.g(paramContext, null); ; this.b = new com.baidu.platform.comapi.map.g(paramContext, paramBaiduMapOptions.a()))
    {
      addView(this.b);
      this.o = new g(this);
      this.b.a().a(this.o);
  ...
  protected final void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt1 < paramInt3)
    {
      ...
      for (Object localObject = localMapViewLayoutParams.b; ; localObject = this.b.a().a((GeoPoint)localObject))
      {
        a(localView);
