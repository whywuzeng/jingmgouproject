...
public final class Address
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof Address))
    {
      ...
      {
        bool1 = bool2;
        if (this.uriHost.equals(paramObject.uriHost))
        {
          bool1 = bool2;
          if (this.uriPort == paramObject.uriPort)
          {
            bool1 = bool2;
            if (Util.equal(this.sslSocketFactory, paramObject.sslSocketFactory))
            {
              ...
              if (Util.equal(this.hostnameVerifier, paramObject.hostnameVerifier))
              {
                ...
                {
                  bool1 = bool2;
                  if (Util.equal(this.authenticator, paramObject.authenticator))
                  {
                    bool1 = bool2;
                    if (Util.equal(this.protocols, paramObject.protocols))
                    {
                      bool1 = bool2;
                      if (Util.equal(this.connectionSpecs, paramObject.connectionSpecs))
                      {
                        bool1 = bool2;
                        if (Util.equal(this.proxySelector, paramObject.proxySelector))
                          bool1 = true;
                      }
                    }
                  }
  ...
  public int hashCode()
  {
    ...
    if (this.proxy != null)
    {
      ...
      label48: if (this.hostnameVerifier == null)
        break label171;
    }
    label166: label171: for (int k = this.hostnameVerifier.hashCode(); ; k = 0)
    {
