...
public final class Connection
{
    ...
    throws IOException
  {
    ...
    for (paramConnectionSpecSelector = Protocol.get(paramConnectionSpecSelector); ; paramConnectionSpecSelector = Protocol.HTTP_1_1)
    {
      ...
      break;
      label483: paramRequest = (Request)localObject2;
      localObject1 = localObject2;
    }
    label498: localObject1 = paramRequest;
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      Util.skipAll((Source)localObject, 2147483647, TimeUnit.MILLISECONDS);
    ...
    throws RouteException
  {
    ...
    try
    {
      for (paramList = new Socket(localProxy); ; paramList = localAddress.getSocketFactory().createSocket())
      {
    ...
    throws RouteException
  {
    ...
    if (!isConnected())
    {
      ...
      connect(paramOkHttpClient.getConnectTimeout(), paramOkHttpClient.getReadTimeout(), paramOkHttpClient.getWriteTimeout(), paramRequest, paramObject, paramOkHttpClient.getRetryOnConnectionFailure());
      if (isFramed())
