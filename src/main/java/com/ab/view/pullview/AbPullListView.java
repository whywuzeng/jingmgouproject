...
public class AbPullListView extends ListView
  implements AbsListView.OnScrollListener
{
  ...
  public AbPullListView(Context paramContext)
  {
    super(paramContext);
    initView(paramContext);
  }

  public AbPullListView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  public void setPullLoadEnable(boolean paramBoolean)
  {
    ...
    this.mFooterView.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        AbPullListView.this.startLoadMore();
      }
    });
  }
 ...
 * Qualified Name:     com.ab.view.pullview.AbPullListView
