...
public class PLA_ListView extends PLA_AbsListView
{
  ...
  public PLA_ListView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (paramAttributeSet != null)
      setOverscrollHeader(paramAttributeSet);
  ...
  private void clearRecycledState(ArrayList<FixedViewInfo> paramArrayList)
  {
    ...
    while (true)
    {
      if (i >= j)
        return;
      PLA_AbsListView.LayoutParams localLayoutParams = (PLA_AbsListView.LayoutParams)((FixedViewInfo)paramArrayList.get(i)).view.getLayoutParams();
  ...
  private void scrollListItemsBy(int paramInt)
  {
    ...
    int j = this.mListPadding.top;
    PLA_AbsListView.RecycleBin localRecycleBin = this.mRecycler;
    if (paramInt < 0)
    {
      ...
      if (localRecycleBin.shouldRecycleViewType(((PLA_AbsListView.LayoutParams)localView.getLayoutParams()).viewType))
      {
  ...
  private void setupChild(View paramView, int paramInt1, int paramInt2, boolean paramBoolean1, int paramInt3, boolean paramBoolean2, boolean paramBoolean3)
  {
    int i;
    boolean bool2;
    label52: label78: PLA_AbsListView.LayoutParams localLayoutParams1;
    int j;
    label163: int k;
    if ((paramBoolean2) && (shouldShowSelector()))
    {
      ...
      label253: onMeasureChild(paramView, paramInt1, k, j);
      label263: j = paramView.getMeasuredWidth();
    ...
    while (true)
    {
      ...
      paramBoolean2 = false;
      break;
      label329: bool2 = false;
      break label52;
      label335: i = 1;
      break label78;
      label341: j = 0;
      break label163;
      label347: localLayoutParams1.forceAdd = false;
      ...
      label397: j = View.MeasureSpec.makeMeasureSpec(0, 0);
      break label253;
      label407: cleanupLayoutState(paramView);
      break label263;
      label415: paramInt2 -= k;
      break label280;
      label423: onOffsetChild(paramView, paramInt1, paramInt3 - paramView.getLeft(), paramInt2 - paramView.getTop());
    }
  }
  ...
  final int measureHeightOfChildren(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    for (paramInt2 = k; ; paramInt2 = k)
    {
      ...
      if ((bool) && (((PLA_AbsListView.RecycleBin)localObject).shouldRecycleViewType(((PLA_AbsListView.LayoutParams)localView.getLayoutParams()).viewType)))
        ((PLA_AbsListView.RecycleBin)localObject).addScrapView(localView);
      ...
      if (this.mItemCount > 0)
        ...
        else
        {
          ...
          if (recycleOnMeasure())
          {
            i = n;
            paramInt2 = m;
            if (this.mRecycler.shouldRecycleViewType(((PLA_AbsListView.LayoutParams)localView.getLayoutParams()).viewType))
            {
  ...
  public boolean removeFooterView(View paramView)
  {
    ...
    {
      boolean bool = false;
      if (((PLA_HeaderViewListAdapter)this.mAdapter).removeFooter(paramView))
      {
        this.mDataSetObserver.onChanged();
        bool = true;
      }
  ...
  public boolean removeHeaderView(View paramView)
  {
    ...
    {
      boolean bool = false;
      if (((PLA_HeaderViewListAdapter)this.mAdapter).removeHeader(paramView))
      {
        this.mDataSetObserver.onChanged();
        bool = true;
      }
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    {
      this.mAdapter = new PLA_HeaderViewListAdapter(this.mHeaderViewInfos, this.mFooterViewInfos, paramListAdapter);
      ...
      checkFocus();
      this.mDataSetObserver = new PLA_AdapterView.AdapterDataSetObserver(this);
 ...
 * Qualified Name:     com.huewu.pla.lib.internal.PLA_ListView
