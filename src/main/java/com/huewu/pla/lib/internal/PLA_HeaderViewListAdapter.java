...
public class PLA_HeaderViewListAdapter
  implements WrapperListAdapter, Filterable
{
  ...
  public PLA_HeaderViewListAdapter(ArrayList<PLA_ListView.FixedViewInfo> paramArrayList1, ArrayList<PLA_ListView.FixedViewInfo> paramArrayList2, ListAdapter paramListAdapter)
  {
  ...
  private boolean areAllListInfosSelectable(ArrayList<PLA_ListView.FixedViewInfo> paramArrayList)
  {
    ...
    do
      if (!paramArrayList.hasNext())
        return true;
    while (((PLA_ListView.FixedViewInfo)paramArrayList.next()).isSelectable);
    return false;
  }
  ...
  public Object getItem(int paramInt)
  {
    ...
    if (paramInt < i)
      return ((PLA_ListView.FixedViewInfo)this.mHeaderViewInfos.get(paramInt)).data;
    int j = paramInt - i;
    paramInt = 0;
    if (this.mAdapter != null)
    {
    ...
    return ((PLA_ListView.FixedViewInfo)this.mFooterViewInfos.get(j - paramInt)).data;
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    int i = getHeadersCount();
    if (paramInt < i)
      return ((PLA_ListView.FixedViewInfo)this.mHeaderViewInfos.get(paramInt)).view;
    int j = paramInt - i;
    paramInt = 0;
    if (this.mAdapter != null)
    {
    ...
    return ((PLA_ListView.FixedViewInfo)this.mFooterViewInfos.get(j - paramInt)).view;
  }
  ...
  public boolean isEnabled(int paramInt)
  {
    int i = getHeadersCount();
    if (paramInt < i)
      return ((PLA_ListView.FixedViewInfo)this.mHeaderViewInfos.get(paramInt)).isSelectable;
    int j = paramInt - i;
    paramInt = 0;
    if (this.mAdapter != null)
    {
    ...
    return ((PLA_ListView.FixedViewInfo)this.mFooterViewInfos.get(j - paramInt)).isSelectable;
  }
  ...
  public boolean removeFooter(View paramView)
  {
    ...
    while (true)
    {
      if (i >= this.mFooterViewInfos.size())
        return false;
      if (((PLA_ListView.FixedViewInfo)this.mFooterViewInfos.get(i)).view == paramView)
      {
  ...
  public boolean removeHeader(View paramView)
  {
    ...
    while (true)
    {
      if (i >= this.mHeaderViewInfos.size())
        return false;
      if (((PLA_ListView.FixedViewInfo)this.mHeaderViewInfos.get(i)).view == paramView)
      {
 ...
 * Qualified Name:     com.huewu.pla.lib.internal.PLA_HeaderViewListAdapter
