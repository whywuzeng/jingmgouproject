...
class b
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    while (i != 2);
    label547: throw new XmlPullParserException("Unexpected start tag in <" + str2 + ">: " + paramXmlPullParser.getName());
    label645: throw new XmlPullParserException("Unexpected end of document in <" + str2 + ">");
  }
    ...
    throws XmlPullParserException, IOException
  {
    ...
    //   1: aconst_null
    //   2: ldc_w 284
    //   5: invokeinterface 307 3 0
    //   10: invokestatic 318	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   13: istore_3
    //   14: iload_3
    //   15: newarray int
    //   17: astore_2
    ...
    //   39: ldc_w 296
    //   42: invokevirtual 121	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   45: ifeq +124 -> 169
    //   48: aload_2
    //   49: iload 4
    //   51: aload_0
    //   52: aconst_null
    //   53: ldc 153
    //   55: invokeinterface 307 3 0
    //   60: invokestatic 318	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   63: iastore
    //   64: iload 4
    //   66: istore 5
    //   68: aload_0
    ...
    //   85: iconst_1
    //   86: if_icmpne -58 -> 28
    //   89: new 52	org/xmlpull/v1/XmlPullParserException
    //   92: dup
    //   93: new 66	java/lang/StringBuilder
    //   96: dup
    //   97: invokespecial 67	java/lang/StringBuilder:<init>	()V
    //   100: ldc 116
    ...
    //   117: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   120: athrow
    //   121: astore_0
    //   122: new 52	org/xmlpull/v1/XmlPullParserException
    //   125: dup
    //   126: ldc_w 365
    //   129: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   132: athrow
    //   133: astore_0
    //   134: new 52	org/xmlpull/v1/XmlPullParserException
    //   137: dup
    //   138: ldc_w 367
    //   141: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   144: athrow
    //   145: astore_0
    //   146: new 52	org/xmlpull/v1/XmlPullParserException
    //   149: dup
    //   150: ldc_w 369
    //   153: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   156: athrow
    //   157: astore_0
    //   158: new 52	org/xmlpull/v1/XmlPullParserException
    //   161: dup
    //   162: ldc_w 371
    //   165: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   168: athrow
    //   169: new 52	org/xmlpull/v1/XmlPullParserException
    //   172: dup
    ...
    //   198: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   201: athrow
    //   202: iload 4
    //   204: istore 5
    //   206: iload_3
    ...
    //   211: aload_0
    //   212: invokeinterface 76 1 0
    //   217: aload_1
    //   218: invokevirtual 121	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   221: ifeq +5 -> 226
    //   224: aload_2
    //   225: areturn
    //   226: aload_0
    //   227: invokeinterface 76 1 0
    //   232: ldc_w 296
    ...
    //   245: istore 5
    //   247: goto -179 -> 68
    //   250: new 52	org/xmlpull/v1/XmlPullParserException
    //   253: dup
    ...
    //   266: aload_1
    //   267: invokevirtual 73	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   270: ldc 125
    //   272: invokevirtual 73	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   275: aload_0
    //   276: invokeinterface 76 1 0
    //   281: invokevirtual 73	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   284: invokevirtual 77	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   287: invokespecial 80	org/xmlpull/v1/XmlPullParserException:<init>	(Ljava/lang/String;)V
    //   290: athrow
    //
    // Exception table:
    //   from	to	target	type
 ...
 * Qualified Name:     com.ta.utdid2.core.persistent.b
