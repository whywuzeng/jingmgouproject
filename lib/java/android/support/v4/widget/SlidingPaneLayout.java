...
public class SlidingPaneLayout extends ViewGroup
{
  ...
  private void onPanelDragged(int paramInt)
  {
    ...
    label141: label149: for (int j = localLayoutParams.rightMargin; ; j = localLayoutParams.leftMargin)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    label396: paramInt1 = localLayoutParams.leftMargin + localLayoutParams.rightMargin;
    if (localLayoutParams.width == -2)
    {
      paramInt1 = View.MeasureSpec.makeMeasureSpec(i3 - paramInt1, -2147483648);
      label429: if (localLayoutParams.height != -2)
        break label610;
      j = View.MeasureSpec.makeMeasureSpec(paramInt2, -2147483648);
      label448: localView.measure(paramInt1, j);
    ...
    label647: for (boolean bool2 = true; ; bool2 = false)
    {
      ...
      break label429;
      label610: if (localLayoutParams.height == -1)
      {
      ...
      if (j < i4)
      {
        ...
        while (true)
        {
          ...
          if (localView.getVisibility() != 8)
            ...
            {
              paramInt1 = 1;
              label750: if (paramInt1 != 0)
              {
                n = 0;
                label757: if ((!bool1) || (localView == this.mSlideableView))
                  break label900;
            ...
            else
            {
              while (true)
              {
                ...
                break label757;
                label850: if (localLayoutParams.height == -1)
                {
                ...
                else
                {
                  ...
                  continue;
                  label885: paramInt1 = View.MeasureSpec.makeMeasureSpec(localView.getMeasuredHeight(), 1073741824);
                }
              }
              if (localLayoutParams.weight > 0.0F)
              {
    ...
    label900: label1035: setMeasuredDimension(k, getPaddingTop() + i + getPaddingBottom());
