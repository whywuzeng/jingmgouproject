  ...
  public String toString()
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        break;
        label838: localStringBuilder.append(this.b);
        break label97;
        label851: localStringBuilder.append(this.c);
        break label146;
        label864: localStringBuilder.append(this.d);
        break label195;
        label877: localStringBuilder.append(this.e);
        break label244;
        label890: localStringBuilder.append(this.f);
        break label293;
        label903: localStringBuilder.append(this.g);
        break label342;
        label916: localStringBuilder.append(this.h);
        break label391;
        label929: localStringBuilder.append(this.i);
        break label440;
        label942: localStringBuilder.append(this.l);
        break label575;
        label955: localStringBuilder.append(this.m);
        break label624;
        label968: localStringBuilder.append(this.o);
        break label716;
        label981: localStringBuilder.append(this.p);
        i1 = i3;
        break label765;
        label996: localStringBuilder.append(this.q);
      }
      label1009: i1 = i2;
    }
  }
