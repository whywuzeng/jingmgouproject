...
public abstract class AbMultiColumnAdapterView<T extends Adapter> extends ViewGroup
{
  ...
  public AbMultiColumnAdapterView(Context paramContext)
  {
    super(paramContext);
  }

  public AbMultiColumnAdapterView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public AbMultiColumnAdapterView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  class AdapterDataSetObserver extends DataSetObserver
  {
    ...
    {
      AbMultiColumnAdapterView.this.mDataChanged = true;
      AbMultiColumnAdapterView.this.mOldItemCount = AbMultiColumnAdapterView.this.mItemCount;
      AbMultiColumnAdapterView.this.mItemCount = AbMultiColumnAdapterView.this.getAdapter().getCount();
      if ((AbMultiColumnAdapterView.this.getAdapter().hasStableIds()) && (this.mInstanceState != null) && (AbMultiColumnAdapterView.this.mOldItemCount == 0) && (AbMultiColumnAdapterView.this.mItemCount > 0))
      {
        AbMultiColumnAdapterView.this.onRestoreInstanceState(this.mInstanceState);
        this.mInstanceState = null;
      }
      while (true)
      {
        AbMultiColumnAdapterView.this.checkFocus();
        AbMultiColumnAdapterView.this.requestLayout();
        return;
        AbMultiColumnAdapterView.this.rememberSyncState();
      }
    }
    ...
    public void onInvalidated()
    {
      ...
      if (AbMultiColumnAdapterView.this.getAdapter().hasStableIds())
        this.mInstanceState = AbMultiColumnAdapterView.this.onSaveInstanceState();
      AbMultiColumnAdapterView.this.mOldItemCount = AbMultiColumnAdapterView.this.mItemCount;
      AbMultiColumnAdapterView.this.mItemCount = 0;
      AbMultiColumnAdapterView.this.mNeedSync = false;
      AbMultiColumnAdapterView.this.checkFocus();
      AbMultiColumnAdapterView.this.requestLayout();
    }
  }
  ...
  {
    public abstract void onItemClick(AbMultiColumnAdapterView<?> paramAbMultiColumnAdapterView, View paramView, int paramInt, long paramLong);
  }

  public static abstract interface OnItemLongClickListener
  {
    public abstract boolean onItemLongClick(AbMultiColumnAdapterView<?> paramAbMultiColumnAdapterView, View paramView, int paramInt, long paramLong);
  }

  public static abstract interface OnItemSelectedListener
  {
    public abstract void onItemSelected(AbMultiColumnAdapterView<?> paramAbMultiColumnAdapterView, View paramView, int paramInt, long paramLong);

    public abstract void onNothingSelected(AbMultiColumnAdapterView<?> paramAbMultiColumnAdapterView);
  }
}

/* Location:           F:\一周备份\面试apk\希望代码没混淆\jingmgou\jingmgou2\classes-dex2jar.jar
 * Qualified Name:     com.ab.view.pullview.AbMultiColumnAdapterView
