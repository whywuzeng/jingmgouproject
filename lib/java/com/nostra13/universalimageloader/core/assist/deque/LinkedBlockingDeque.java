  ...
  implements BlockingDeque<E>, Serializable
{
  ...
  public LinkedBlockingDeque(Collection<? extends E> paramCollection)
  {
    ...
    while (true)
    {
      ...
      if (!linkLast(new Node(localObject)))
  ...
  public E peekFirst()
  {
    ...
    try
    {
      ...
      for (localObject1 = null; ; localObject1 = this.first.item)
        return localObject1;
    }
    finally
    {
  ...
  public E peekLast()
  {
    ...
    try
    {
      ...
      if (localObject1 == null);
      for (localObject1 = null; ; localObject1 = this.last.item)
        return localObject1;
    }
    finally
    {
  ...
  public String toString()
  {
    ...
    try
    {
      ...
      while (true)
      {
        Object localObject4 = ((Node)localObject1).item;
        Object localObject3 = localObject4;
        if (localObject4 == this)
          localObject3 = "(this Collection)";
        localStringBuilder.append(localObject3);
        localObject1 = ((Node)localObject1).next;
        if (localObject1 == null)
        {
          localObject1 = ']';
          return localObject1;
    ...
    implements Iterator<E>
  {
    ...
    void advance()
    {
      ...
      try
      {
        ...
        if (this.next == null);
        for (Object localObject1 = null; ; localObject1 = this.next.item)
        {
