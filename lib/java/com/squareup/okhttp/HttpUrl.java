...
public final class HttpUrl
{
  ...
  public static final class Builder
  {
    ...
    private static String canonicalizeHost(String paramString, int paramInt1, int paramInt2)
    {
      ...
      while (HttpUrl.delimiterOffset(str, 0, paramInt1, "") == paramInt1);
      return null;
    }
    ...
    private static InetAddress decodeIpv6(String paramString, int paramInt1, int paramInt2)
    {
      ...
      try
      {
        label349: paramString = InetAddress.getByAddress(arrayOfByte);
        return paramString;
      }
    ...
    HttpUrl parse(HttpUrl paramHttpUrl, String paramString)
    {
      ...
      label310: for (int m = paramString.charAt(n); ; m = -1)
        switch (m)
        {
        default:
          break;
      ...
      label475: this.host = canonicalizeHost(paramString, j, i);
      this.port = HttpUrl.defaultPort(this.scheme);
      label497: if (this.host == null)
        return null;
      int j = n;
      while (true)
      {
        ...
        return build();
        label626: this.encodedUsername = paramHttpUrl.encodedUsername();
