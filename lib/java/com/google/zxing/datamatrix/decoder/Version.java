...
public final class Version
{
  ...
  private Version(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, ECBlocks paramECBlocks)
  {
    ...
    paramInt2 = 0;
    paramInt1 = i;
    while (paramInt1 < paramECBlocks.length)
    {
      Object localObject = paramECBlocks[paramInt1];
      paramInt4 = localObject.getCount();
      paramInt2 += (localObject.getDataCodewords() + paramInt3) * paramInt4;
      paramInt1 += 1;
    }
    ...
    throws FormatException
  {
    ...
    int j = VERSIONS.length;
    int i = 0;
    while (i < j)
    {
      Version localVersion = VERSIONS[i];
  ...
  static final class ECB
  {
    ...
    ECB(int paramInt1, int paramInt2, Version.1 param1)
    {
  ...
  static final class ECBlocks
  {
    ...
    ECBlocks(int paramInt, Version.ECB paramECB, Version.1 param1)
    {
      this(paramInt, paramECB);
    }
    ...
    ECBlocks(int paramInt, Version.ECB paramECB1, Version.ECB paramECB2, Version.1 param1)
    {
      this(paramInt, paramECB1, paramECB2);
    }
