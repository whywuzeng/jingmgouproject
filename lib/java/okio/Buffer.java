  ...
  implements BufferedSource, BufferedSink, Cloneable
{
  ...
  public Buffer copyTo(Buffer paramBuffer, long paramLong1, long paramLong2)
  {
    ...
    while (true)
    {
      ...
      break label103;
      break;
      label215: paramBuffer.head.prev.push(localSegment1);
    }
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (l1 < this.size)
    {
      l2 = Math.min(localSegment.limit - i, paramObject.limit - j);
      int m = 0;
      k = i;
      i = j;
      j = k;
  ...
  public void write(Buffer paramBuffer, long paramLong)
  {
    ...
    label162: label168: for (int i = 0; ; i = localSegment1.pos)
    {
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      while (true)
      {
        ...
        else
        {
          ...
          label457: i = 65536 + ((0xFFFF27FF & k) << 10 | 0xFFFF23FF & i);
          writeByte(i >> 18 | 0xF0);
